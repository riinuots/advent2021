library(tidyverse)
library(igraph)
n = read_lines("solutions/day15/input", n_max = 1)
str_count(n)
...
distances(cave, "1-1", "100-100", mode = "out")
# distances(cave, "1-1", "10-10", mode = "out")
...
path = shortest_paths(cave, "1-1", "10-10", output = "both")
...
p1 = p + geom_point(data = mypath, colour = "orange", alpha = 0.6, size = 3)
p1
